...
import org.dockersim.FileItem;
import org.dockersim.Task;
import org.dockersim.Parameters;
import org.dockersim.Parameters.FileType;
import org.dockersim.ReplicaCatalog;
 ...
 * @date Nov 9, 2014
 */
public final class MicroflowParser {
     ...
     * mode
     */
    public MicroflowParser(int userId) {
        this.userId = userId;
     ...
     */
    public void parse(String daxPath) {
        if (daxPath != null) {
