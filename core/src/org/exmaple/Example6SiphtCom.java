...
public class Example6SiphtCom {
    ...
    private static void launch(int userId, List<VmType> vmTypes) throws IOException {
        ...
        String resulitFileName = "SIPHT_COM" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + ".txt";
        ...
        String destDir = "D:/dockersim/data/SIPHT";
    ...
    private static void initailMicroFlows(int userId,
        ...
        for (int w = 0; w < workflowNumber; w++) {
            ...
            daxPaths.add(destDir + File.separator +
                    "SIPHT" + "_" + workflowNumber + "_" + taskNumber + "_" + w + ".xml");
